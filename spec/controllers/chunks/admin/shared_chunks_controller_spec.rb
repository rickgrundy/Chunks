...
describe Chunks::Admin::SharedChunksController do    
  it "lists all shared chunks, ordered by name" do
    shared_a = Factory(:shared_chunk, name: "A")
    shared_c = Factory(:shared_chunk, name: "C")
    shared_b = Factory(:shared_chunk, name: "B")
  ...
  describe "editing a shared chunk" do
    ...
    it "fails on validation errors" do
      ...
      @shared.chunk.reload.title.should == "Title From Factory"      
    end
